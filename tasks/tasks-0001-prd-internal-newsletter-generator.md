...
- [x] 1.0 Establish backend contracts and validation
...
- [x] 2.0 Implement audio and text summarization services
...
- [x] 3.0 Assemble structured newsletter output
...
- [x] 4.0 Generate and refine freeform topic suggestions
...
- [x] 5.0 Build the user interface for upload, preview, and editing
